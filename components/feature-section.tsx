...
const tabs = {
  newsroom: {
    ...
    title: "Track breaking stories, detect coordinated misinformation, and share transparent evidence with your audience.",
  ...
  readers: {
    ...
    tagClass: "bg-green-50 text-green-700 dark:bg-green-950 dark:text-green-300",
  ...
  privacy: {
    tag: "Privacy first",
    tagClass: "bg-amber-50 text-amber-700 dark:bg-amber-950 dark:text-amber-300",
    title: "Your data stays yours. No trackers, no ad targeting, no selling your activity.",
...
export default function FeaturesSection() {
  ...
  const switchTab = (key: TabKey) => {
    ...
    setVisible(false);
    setTimeout(() => { setActive(key); setVisible(true); }, 220);
  };
  ...
  return (
    <section className="my-6 sm:my-8">
      <div className="border rounded-lg p-4 flex flex-col gap-4">
        ...
        >
          <span className={cn("inline-flex text-xs font-medium px-3 py-1 rounded-full mb-3", t.tagClass)}>
            {t.tag}
          </span>
          ...
          <div className="grid grid-cols-3 gap-6 mt-4 h-40 bg-linear-to-b from-accent via-transparent to-accent rounded-md border">
            {t.stats.map((s) => (
              <div key={s.label} className="border-r">
